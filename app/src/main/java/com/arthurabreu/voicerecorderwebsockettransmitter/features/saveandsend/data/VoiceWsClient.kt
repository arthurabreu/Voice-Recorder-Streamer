...
class VoiceWsClient(
    ...
    override suspend fun sendText(json: String): Boolean = webSocket?.send(json) == true
    override suspend fun sendBinary(bytes: ByteArray): Boolean = webSocket?.send(ByteString.of(*bytes)) == true
